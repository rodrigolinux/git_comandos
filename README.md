...
Exibir informações resumidas em uma linha (Exibe: Hash completa e Comentário)
...
git blame -L 12,22 NomeArquivo.txt
...
Para criar uma tag assinada é necessário uma Chave GPG Privada (GNU Privacy Guard)
